...
If you are making a map plot, then the map object is `cfp.plotvars.mymap` and this is the object (basemao based) you should operate on. To see all the methods for the plot object type: `cfp.gopen(); dir(cfp.plotvars.plot)` or `dir(cfp.plotvars.mymap)`.
...
## 0. Quick links<a class="anchor" id="chapter0"></a>
